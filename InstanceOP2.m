classdef InstanceOP2 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_2.mat');
            data.nDie      = 20;                                % 晶片的数量
            data.nChainMax = 20;                                % 所允许的最多的测试链
            data.P         = Instance_2.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_2.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
             R = [842.0640 3958.13]; % HV
            %R = [126.3096,1401.4208;168.4128,1186.8288;210.516,1181.3376]; % IGD
        end
    end
end