classdef InstanceOP3 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_3.mat');
            data.nDie      = 30;                                % 晶片的数量
            data.nChainMax = 30;                                % 所允许的最多的测试链
            data.P         = Instance_3.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_3.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
             R = [1.2631e+03 6281.07]; % HV
            %R = [126.3096,2266.24;168.4128,1955.936;210.516,1922.5344;252.6192,1917.0432]; % IGD
        end
    end
end