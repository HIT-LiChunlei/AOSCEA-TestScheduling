classdef InstanceOP4 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_4.mat');
            data.nDie      = 40;                                % 晶片的数量
            data.nChainMax = 40;                                % 所允许的最多的测试链
            data.P         = Instance_4.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_4.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
             R = [1.6841e+03 6258.64]; % HV
            %R = [126.3096,2206.3577;168.4128,1777.5882;210.516,1520.6085;252.6192,1471.6485;294.7224,1417.9968;378.9288,1407.7706;547.3416,1393.3829]; % IGD
        end
    end
end