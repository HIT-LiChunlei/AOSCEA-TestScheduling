classdef InstanceOP5 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_5.mat');
            data.nDie      = 50;                                % 晶片的数量
            data.nChainMax = 50;                                % 所允许的最多的测试链
            data.P         = Instance_5.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_5.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
             R = [2.1052e+03 10823.4]; % HV
            %R = [126.3096,4010.9898;168.4128,3479.0282;210.516,3299.3024;294.7224,3287.2901];
        end
    end
end