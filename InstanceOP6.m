classdef InstanceOP6 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_6.mat');
            data.nDie      = 60;                                % 晶片的数量
            data.nChainMax = 60;                                % 所允许的最多的测试链
            data.P         = Instance_6.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_6.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
             R = [2.5262e+03 7781.63]; % HV
            %R =[126.3096,2742.0608;168.4128,2323.4506;210.516,2151.0528;252.6192,2052.0256;294.7224,2028.864;336.8256,1922.9184;378.9288,1909.7728]; %IGD
        end
    end
end