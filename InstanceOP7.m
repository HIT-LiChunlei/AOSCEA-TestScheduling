classdef InstanceOP7 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_7.mat');
            data.nDie      = 70;                                % 晶片的数量
            data.nChainMax = 70;                                % 所允许的最多的测试链
            data.P         = Instance_7.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_7.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
            R = [2.9472e+03 10012.1]; % HV
            % R =[168.4128,3101.4282;210.516,2681.3253;252.6192,2577.9776;294.7224,2539.3989;336.8256,2418.4133;378.9288,2367.7376;421.032,2354.5733;505.2384,2348.2058;589.4448,2333.6261];
        end
    end
end