classdef InstanceOP8 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_8.mat');
            data.nDie      = 80;                                % 晶片的数量
            data.nChainMax = 80;                                % 所允许的最多的测试链
            data.P         = Instance_8.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_8.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
             R = [3.3683e+03 12891.5]; % HV
            % R = [252.6192,3530.3636;294.7224,3380.3077;336.8256,3090.2912;378.9288,2851.1877;547.3416,2839.4624;589.4448,2787.0784];
        end
    end
end