classdef InstanceOP9 < PROBLEM
    ...
    methods
        ...
        function Population = Evaluation(obj,varargin)
            load('Instance_9.mat');
            data.nDie      = 90;                                % 晶片的数量
            data.nChainMax = 90;                                % 所允许的最多的测试链
            data.P         = Instance_9.power;                  % 每个晶片对应的测试功率
            data.T         = Instance_9.time;                   % 每个晶片对应的测试时间
        ...
        function R = GetOptimum(obj,~)
             R = [3.7893e+03 12750.2]; % HV
            % R =[378.9288,3890.0672;421.032,3292.928;463.1352,3259.3413;547.3416,3230.7584;631.548,3099.7056;673.6512,3080.64]; % IGD
        end
    end
end